            ...
            <div class="panel-body">
                <table class="table table-striped task-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ Route('task.complete',['id'=>23]) }}" type="submit" class="btn btn-success">
                                <i class="fa fa-btn fa-check"></i>Hoàn thành
                            </a>
                        </td>
                        <!-- Task Delete Button -->
                        <td>
                            <form action="{{ Route('task.destroy',['id' => 23]) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                    ...
                    <tr>
                        ...
                        <!-- Task Complete Button -->
                        <td>
                            <a href="{{ Route('task.complete',['id'=>43]) }}" type="submit" class="btn btn-success">
                                <i class="fa fa-btn fa-check"></i>Hoàn thành
                            </a>
                        </td>
                        <!-- Task Delete Button -->
                        <td>
                            <form action="{{ Route('task.destroy',['id' => 43]) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                    ...
                    <tr>
                        ...
                        <!-- Task Complete Button -->
                        <td>
                            <a href="{{ Route('task.reComplete',['id'=>84]) }}" type="submit" class="btn btn-success">
                                <i class="fa fa-btn fa-refresh"></i>Làm lại
                            </a>
                        </td>
                        <!-- Task Delete Button -->
                        <td>
                            <form action="{{ Route('task.destroy',['id' => 84]) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
